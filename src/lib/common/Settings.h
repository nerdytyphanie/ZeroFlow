...
public:
  ...
  struct Client
  {
    ...
    inline static const auto LastServerId = QStringLiteral("client/lastServerId");
    inline static const auto RemoteHost = QStringLiteral("client/remoteHost");
    inline static const auto SelectedServerId = QStringLiteral("client/selectedServerId");
  ...
  struct Server
  {
    ...
    inline static const auto DiscoveryId = QStringLiteral("server/discoveryId");
